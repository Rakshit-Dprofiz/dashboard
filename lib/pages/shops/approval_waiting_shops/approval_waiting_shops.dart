          ...
          Row(
            children: [
              IconButton(
                ...
                onPressed: () {
                  Get.toNamed(TRoutes.approvalScreen,
                      arguments: data); // ✅ Pass data correctly
                },
              ),
              IconButton(
                icon: const Icon(Iconsax.close_circle, color: Colors.red),
                onPressed: () {
                  Get.toNamed(TRoutes.disapprovalScreen,
                      arguments: data); // ✅ Pass data correctly
                },
              ),
            ],
...
class ApprovalWaitingShopsScreen extends StatelessWidget {
  ApprovalWaitingShopsScreen({super.key});
