...
//         "Rejected Count":
//             "${(index % 5) + 1}", // Random rejection count between 1-5
//         "Rejected Reason": (index % 3 == 0)
...
// class RejectedShops extends StatelessWidget {
//   RejectedShops({super.key});
  ...
  void fetchDummyData() {
    List<Map<String, String>> dummyData = List.generate(
      36,
        ...
        "Phone No": "98765432${index % 10}",
        "Owner Email": "owner${index + 1}@shop.com",
        "Rejected Count": "${(index % 5) + 1}", // Random rejection count between 1-5
        "Rejected Reason": (index % 3 == 0)
            ? "Incomplete Documents"
            : (index % 3 == 1)
            ? "Invalid GST"
