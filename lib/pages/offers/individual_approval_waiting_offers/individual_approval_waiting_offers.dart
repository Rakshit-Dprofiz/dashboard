...
import '../../shops/approval_waiting_shops/approve/approval.dart';
          ...
          Row(
            children: [
              ...
              IconButton(
                ...
                onPressed: () {
                  Get.to(() => ApprovalScreen (), arguments: data);
                },
              ),IconButton(
...
class IndividualApprovalWaitingOffersScreen extends StatelessWidget {
  IndividualApprovalWaitingOffersScreen({super.key});
          ...
          children: [
            Row(
              children: [
                ...
                const Text(
                  "Individual Approval Waiting Offers",
                  style: TextStyle(
                    fontSize: 20,
